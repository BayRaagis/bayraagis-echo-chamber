  ...
  return (
    <Layout>
      <div className="container mx-auto py-16 px-4 flex flex-col items-center min-h-[60vh]">
        ...
        <div className="bg-white rounded-2xl shadow-md p-10 max-w-2xl w-full text-center space-y-6">
          <p className="text-lg text-gray-800">
            Please donate to our parent organization Sangeethamsha,<br></br>
            a 501(c)(3) non-profit for popularizing and promoting<br></br>
            classical music from South Asia in the Bay Area and globally.
          </p>
          ...
          <a
            ...
            href={`https://givebutter.com/sangeethaamsha`}
